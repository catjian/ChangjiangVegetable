...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, DIF_PX(170), DIF_PX(130))];
        [self.imageView setCenterX:DIF_SCREEN_WIDTH/2/2];
        [self.imageView.layer setCornerRadius:5];
        [self.imageView.layer setMasksToBounds:YES];
        [self.contentView addSubview:self.imageView];
        
        UIImageView *playView = [[UIImageView alloc] initWithFrame:CGRectMake(0, DIF_PX(32), DIF_PX(36), DIF_PX(36))];
