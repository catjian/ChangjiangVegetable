...
@interface ShopTypeListViewController () <UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate>

@end

@implementation ShopTypeListViewController
{
...
- (void)createPageController
{
    ...
    for (int i = 0; i < titleArr.count; i++)
    {
        ...
        [btn setFrame:CGRectMake(i*(DIF_SCREEN_WIDTH/3), 0, DIF_SCREEN_WIDTH/3, DIF_PX(32))];
...
- (void)createCollectionView
{
    ...
    [m_ContentView setBackgroundColor:DIF_HEXCOLOR(@"f6f6f6")];
...
{
    ShopTypeListViewCell *cell = [ShopTypeListViewCell cellClassName:@"ShopTypeListViewCell" InTableView:tableView forContenteMode:nil];
    return cell;
}
